                                        ...
                                        <div class="js-scrollbar u-sidebar__body">
                                            <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                ...
                                                <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                    ...
                                                    @php $flag+=1; @endphp
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer" href="{{url('/'.$more_category->slug)}}" data-target="#headerSidebarCollapse{{$flag}}" 
                                                        role="button" data-toggle="collapse" aria-expanded="false" aria-controls="headerSidebarCollapse{{$flag}}">
                                                            {{$more_category->title}}
                                                        </a>
                                                        <div id="headerSidebarCollapse{{$flag}}" class="collapse" data-parent="#headerSidebarContent">
                                                            <ul class="u-header-collapse__nav-list">
                    ...
                    <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar  u-header__navbar--no-space">
                        ...
                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                            <ul class="navbar-nav u-header__navbar-nav">
                                ...
                                <!-- End Home -->
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut" data-position="left">
                                    <a id="homeMegaMenu{{$count}}" class="nav-link u-header__nav-link text-gray-30 u-header__nav-link-toggle" aria-haspopup="true" aria-expanded="false" href="javascript:void(0);">More Categories</a>
                                                ...
                                                <div class="more-categories">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                            ...
                                                            @php $count += 1; @endphp
                                                            <button class="nav-link {{($count==1) ? ' active' : '' }} w-100" id="v-pills-{{$count}}-tab" data-bs-toggle="pill" data-bs-target="#v-pills-{{$count}}" type="button" role="tab" aria-controls="v-pills-{{$count}}" aria-selected="true">{{$nav_more_category->title}}</button>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-9 col-lg-9 col-sm-9 ml-5">
                                                <div class="row">
                                                    <div class="tab-content w-100" id="v-pills-tabContent">
                                                        ...
                                                        @foreach($nav_more_categories as $nav_more_category)
                                                        @php $count += 1; @endphp
                                                        <div class="tab-pane fade {{($count==1) ? ' show active' : '' }}" id="v-pills-{{$count}}" role="tabpanel" aria-labelledby="v-pills-{{$count}}-tab">
                                                            <div class="row">
