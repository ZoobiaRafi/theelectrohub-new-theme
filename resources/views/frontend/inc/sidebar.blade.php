                                ...
                                <form class="js-validate">
                                    ...
                                    <div id="login" data-target-group="idForm">
                                        ...
                                        <div class="alert alert-warning alert-dismissible fade show" style="display: none;" role="alert">
                                            <span class="alert-text-warning"><strong>No user found!</strong> Invalid email or password.</span>
                                        ...
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-block btn-sm btn-primary text-white transition-3d-hover btn-login">Login</button>
                                        </div>
                                    ...
                                    <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                        ...
                                        <!-- Title -->
                                        <header class="text-center mb-7">
                                        <h2 class="h4 mb-0">Welcome to {{ucwords(config('app.name'))}}.</h2>
                                        ...
                                        <div class="form-group">
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="email" id="signupname" placeholder="Name" aria-label="name" aria-describedby="signupnameLabel" required
                                        ...
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-block text-white btn-sm btn-primary transition-3d-hover btn-register">Get Started</button>
                                        </div>
                                    ...
                                    <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                        ...
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-block btn-sm btn-primary text-white transition-3d-hover btn-recover-password">Recover Password</button>
                                        </div>
